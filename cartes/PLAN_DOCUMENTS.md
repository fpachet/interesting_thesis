...
| `input/Hidden_Biases_in_Conditioning_Autoregressive_Models.pdf` | couverture propositionnelle complète | version longue de 16 pages soumise à NeurIPS ; biais inférentiels et état borné ; ancrage technique de l'articulation sampling/résolution, non théorie directe de l'intéressant |
| `input/Tonal_Parsimony_in_Chord_Sequence_Analysis.pdf` | couverture propositionnelle complète | prépublication arXiv de 20 pages ; continuité tonale locale, vocabulaire global et anti-compression comme test réflexif de la fonction objectif |
