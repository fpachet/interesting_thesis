...
| 6 | `input/old_docs/ERCInteractiveReflexions2.docx` | Grand projet sur les interactions reflexives et la creation ; pont entre interestingness, IA et experimentation. | Extraire propositions, protocoles et differences entre musique, texte et dessin. |
| 7 | `input/old_docs/Paper citations_updated.docx` | Projet Sense of Direction ; traite innovation, structure longue et dimensions heterogenes en IA generative. | Distinguer les propositions propres du texte des citations et du workplan. |
| 8 | `input/old_docs/Interesting Interactions (sent to Luc).doc` | Formulation concentree des systemes reflexifs et du Continuator. | Comparer avec le projet ERC et ne conserver que les propositions distinctes. |
| 9 | `input/old_docs/TBKLullyNOTES.doc` | Notes fragmentaires mais riches en intuitions originales sur parcours, mauvais objets, apprentissage et temporalite. | Examiner chaque fragment et ne retenir que les propositions substantielles. |

## Priorite B - Fondations et contrepoints majeurs

| Rang | Document | Pourquoi il est important | Travail attendu |
| ---: | --- | --- | --- |
| 10 | `input/old_docs/interestingness.pdf` | Schmidhuber fournit une theorie computationnelle centrale : regularites apprenables, curiosite et progres de compression. | Couverture propositionnelle complete ; 23 pages verifiees et formulations precisees. |
...
| 6 | `input/old_docs/ERCInteractiveReflexions2.docx` | couverture propositionnelle complete | 12 juillet 2026 |
| 7 | `input/old_docs/Paper citations_updated.docx` | couverture propositionnelle complete | 12 juillet 2026 |
| 8 | `input/old_docs/Interesting Interactions (sent to Luc).doc` | couverture propositionnelle complete | 12 juillet 2026 |
| 9 | `input/old_docs/TBKLullyNOTES.doc` | couverture propositionnelle complete | 12 juillet 2026 |
| 10 | `input/old_docs/interestingness.pdf` | couverture propositionnelle complete | 12 juillet 2026 |
