---
id: idea_0111
title: "Autonomie mélodique et mobilité harmonique peuvent se renforcer au lieu de s'opposer"
kind: hypothesis
level: conceptual
status: inbox
sources:
...
et cohérente - tout en faisant voyager constamment son harmonie. La mobilité harmonique
n'affaiblit pas nécessairement l'identité mélodique : elle peut suivre ses inflexions,
déplacer silencieusement son centre tonal et donner une nécessité à des notes qui
sembleraient autrement ordinaires ou improbables.

L'équilibre est étroit. Trop de mouvements harmoniques rendent la construction
démonstrative ou dense ; trop peu la rabattent sur la monotonie d'une boucle. Une
modulation trop spectaculaire attire l'attention sur le procédé ; une harmonie trop
statique ne soutient plus la trajectoire. Dans le régime nommé Jotney, le travail
harmonique reste assez mobile pour porter l'invention et assez discret pour que la
chanson paraisse simple.

Jotney doit donc être compris comme un régime compositionnel graduel, non comme un genre
ou une étiquette géographique : une chanson peut être plus ou moins Jotney selon la
manière dont ces deux dimensions se soutiennent. Les traits proposés (basse chromatique,
