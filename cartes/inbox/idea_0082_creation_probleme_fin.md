...
décisions locales n'indique nécessairement quand s'arrêter, alors que la fin rétroagit
...
- Trouve dans `idea_0137` son analogue du côté de la vie de l'intéressant :
  produire une fin n'équivaut pas à épuiser l'objet.
