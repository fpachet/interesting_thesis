...
\date{État de travail du 4 août 2026}
...
\Needspace{8\baselineskip}
\subsection{Garve anticipe la construction par lacune ; la thèse doit en préciser la résistance et la relance}
...
\end{quote}
{\footnotesize\color{metadata}\textbf{Provenance :} passages-interessant-etat-art.md; interessant-etat-art.md. Texte primaire contrôlé dans la transcription du Deutsches Textarchiv et la numérisation de l'Universitäts- und Landesbibliothek Sachsen-Anhalt. Les formulations françaises citées sont des traductions de travail ; toute citation de thèse devra être contrôlée sur l'allemand. Nannini sert de guide historique, non de substitut au texte de Garve.\par}
{\footnotesize\color{metadata}\textbf{Références :} \parencite{garve1779interessirende,nannini2018garve,pachet2027virtuosite}\par}
