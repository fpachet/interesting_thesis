...
L'hypothèse centrale est simple : est intéressant, pour un sujet, ce qui
déclenche chez lui un processus de construction. Le sujet commence alors à
...
étudiera ensuite les propriétés de l'intéressant dans cinq domaines : musique,
intelligence artificielle, créativité, philosophie et littérature. Elle
examinera enfin une hypothèse nouvelle : l'intéressant peut contribuer à faire
...
Les chansons Jotney fourniront un cas directeur : elles cherchent à maintenir
une mélodie autonome et chantable tout en faisant voyager l'harmonie sans
exhiber le procédé. \emph{Histoire d'une oreille} apporte deux moyens de les
étudier \parencite{pachet2018oreille}. L'écoute superposée compare mentalement
des variantes. L'\emph{optale} désigne le sentiment qu'une forme est un optimum
local parce que ses variantes proches échouent ; la \emph{pseudoptale} rappelle
que la familiarité peut simuler cette nécessité. La parcimonie tonale donnera
un autre cas : une analyse compacte devient utile si elle permet d'anticiper,
de varier ou d'intervenir, mais perd sa valeur lorsqu'elle efface une différence
musicalement pertinente \parencite{pachet2026tonalparsimony}.
...
Les systèmes réflexifs et le Continuator permettent d'étudier la relation entre
un sujet et une image imparfaite, continuellement révisée, de sa propre pratique
...
La succession des systèmes apporte elle-même une leçon. Les premiers modèles
isolaient surtout des régularités musicales ; l'écoute active a introduit le
...
Elle s'en servira pour suivre les déplacements de la question.
...
\subsection{Créativité, philosophie et littérature}
...
présupposés et à produire des contre-exemples. Ils permettront aussi d'étudier
l'auto-application : une théorie de l'intéressant doit rendre compte des
questions qu'elle fait naître, tout en distinguant cette fécondité de sa vérité.
Le projet \emph{Snarky}, qui formalise la troisième partie de l'\emph{Éthique}
de Spinoza, servira de cas. La formalisation n'assure pas une interprétation
juste, mais oblige à reconstruire les dépendances entre définitions, axiomes et
propositions.
...
\begin{enumerate}
  ...
  \item une série d'épreuves dans la musique, l'IA, la créativité, la
        philosophie et la littérature, avec une distinction constante entre
        cible, indicateur et résultat effectif.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \textbf{Le concept au travail} : musique ; intelligence artificielle ;
        créativité ; philosophie ; littérature ; comparaison des résultats et
        révision du concept.
\end{enumerate}
