...
- titre provisoire : *L'émergence de l'intéressant. Naissance des idées,
  compréhension et singularité des formes* ;
- question directrice : sous quelles conditions quelque chose apparaît-il à un
  sujet comme intéressant ?
- hypothèse relationnelle entre forme, mémoire et sujet ;
- triplet intelligibilité, singularité et fécondité ;
- objet intéressant comme nécessité inventée et problème rendu visible par sa
  solution ;
- musique comme laboratoire temporel, avec le régime Jotney comme cas
  exploratoire ;
- axes sur rareté, autostabilité, difficulté de production et difficultuosité ;
- méthode associant analyse conceptuelle, auteurs philosophiques, cas et apports
...
et les apports d'*Histoire d'une oreille* ne sont pas encore incorporés au texte
du projet.
